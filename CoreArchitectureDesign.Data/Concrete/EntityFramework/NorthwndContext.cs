...
namespace CoreArchitectureDesign.Data.Concrete.EntityFramework
{
    public partial class NorthwndContext : DbContext
    {
        ...
        //        optionsBuilder.UseSqlServer("Server=.\\;Database=NORTHWND;User ID=sa; Password=1qaz2wsX;Trusted_Connection=True;");
        //    }
        //}
    ...
    public class Alphabeticallistofproducts : BaseEntity
    {
        [Key]
